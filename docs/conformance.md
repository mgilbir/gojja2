...
**5145 of 5174 gradable cases (99.4%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["5145 / 5174 gradable  (99.4%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2854 | 2829 |
