...
**5409 of 5438 gradable cases (99.5%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["5409 / 5438 gradable  (99.5%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 3118 | 3093 |
