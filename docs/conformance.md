...
**5345 of 5372 gradable cases (99.5%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["5345 / 5372 gradable  (99.5%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 3052 | 3029 |
