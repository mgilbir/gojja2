...
**4733 of 4753 gradable cases (99.6%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4733 / 4753 gradable  (99.6%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2433 | 2417 |
