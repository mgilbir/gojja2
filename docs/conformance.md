...
**5087 of 5113 gradable cases (99.5%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["5087 / 5113 gradable  (99.5%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2793 | 2771 |
