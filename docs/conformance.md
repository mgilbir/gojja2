...
**4950 of 4968 gradable cases (99.6%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4950 / 4968 gradable  (99.6%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2648 | 2634 |
