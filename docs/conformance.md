...
**5400 of 5430 gradable cases (99.4%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["5400 / 5430 gradable  (99.4%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 3110 | 3084 |
