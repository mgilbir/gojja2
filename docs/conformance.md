...
**5406 of 5436 gradable cases (99.4%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["5406 / 5436 gradable  (99.4%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 3116 | 3090 |
