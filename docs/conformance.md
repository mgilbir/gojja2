...
**4836 of 4854 gradable cases (99.6%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4836 / 4854 gradable  (99.6%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2534 | 2520 |
