...
**4926 of 4944 gradable cases (99.6%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4926 / 4944 gradable  (99.6%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2624 | 2610 |
