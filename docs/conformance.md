...
**4824 of 4842 gradable cases (99.6%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4824 / 4842 gradable  (99.6%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2522 | 2508 |
