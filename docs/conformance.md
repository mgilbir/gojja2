...
**4606 of 4620 gradable cases (99.7%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4606 / 4620 gradable  (99.7%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2300 | 2290 |
