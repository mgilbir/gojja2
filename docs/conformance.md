...
**4959 of 4977 gradable cases (99.6%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4959 / 4977 gradable  (99.6%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2657 | 2643 |
