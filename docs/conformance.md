...
**4636 of 4650 gradable cases (99.7%)** match CPython jinja2, across eight
...
flowchart LR
    ...
    TC --> RATE["4636 / 4650 gradable  (99.7%)"]
...
|---|---|---|
| gojja2's own (committed, with goldens) | 2330 | 2320 |
